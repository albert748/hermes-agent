...
class TestCLIStatusBar:
    ...
    def test_session_token_total_shown_in_wide_status_bar(self):
        # Ported Σ readout (dev-local 481647d23d): snapshot carries
        # session_total_tokens and the status bar renders it compactly.
        cli_obj = _attach_agent(
            _make_cli(),
            prompt_tokens=10_230,
            completion_tokens=2_220,
    ...
    def test_session_token_total_shown_in_fragments(self):
        cli_obj = _attach_agent(
            _make_cli(),
            prompt_tokens=10_230,
            completion_tokens=2_220,
        ...
        assert any("Σ 12.4K" in t for t in frag_texts)
