    ...
    for i, tool_call in enumerate(assistant_message.tool_calls, 1):
        ...
        if function_name == "todo":
            ...
            def _execute(next_args: dict) -> Any:
                ...
                # LLM can autonomously call memory remove/replace, deleting
                # entries it considers unimportant. Save a timestamped backup
                # before mutate (memsinker consumes *.preremove.bak).
