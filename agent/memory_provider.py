...
class MemoryProvider(ABC):
    ...
    def prefetch(self, query: str, *, session_id: str = "", model: str = "") -> str:
        ...
        model is the active LLM model name — providers may use it to
        vary context injection by model capability.
        """
        return ""
